<?php
class Email_lista_Model extends MY_Model {
    ...
    public function __construct()
    {
        ...
        $this->database = array('db' => 'email_mkt', 'table' => 'email_lista');
    ...
    {
    	$data['coluna'] = '
                            email_lista.id as id, 
                            email_lista.titulo as descricao ,
                            email_lista.function as function 
                            ';
    	$data['tabela'] = array(
                                array('nome' => $this->database['table']),
                                );
    ...
    public function get_itens( $filtro = array(), $coluna = 'id', $ordem = 'DESC', $off_set = NULL )
    {
    	$data['coluna'] = ''
                . 'email_lista.id as id'
                . ', email_lista.titulo as titulo'
                . ', email_lista.observacao as observacao'
                . ', email_lista.function as function'
                ;
    	$data['tabela'] = array(
                                array('nome' => $this->database['table']),
