	...
	private function _inicia_listagem( $itens, $extras = NULL, $exportar = FALSE )
	{
		...
		else 
		{
			$data['cabecalho'] = array(
                                                    ...
                                                    (object)array( 'chave' => 'data_ini','titulo' => 'Inicio','link' => str_replace(array('[col]','[ordem]'), array('data_ini',( ($extras['ordem'] == 'ASC' && $extras['col'] == 'data_ini') ? 'DESC' : 'ASC' ) ), $extras['url']), 'class' => ( ($extras['col'] == 'data_ini' ) ? 'ui-state-highlight'.( ($extras['col'] == 'data_ini' && $extras['ordem'] == 'ASC') ? ' ui-icon-caract-1-n' : ' ui-icon-caract-1-s' ) : 'ui-state-disabled ui-icon-caract-1-s' ) ),
                                                    (object)array( 'chave' => 'data_fim','titulo' => 'Fim','link' => str_replace(array('[col]','[ordem]'), array('data_fim',( ($extras['ordem'] == 'ASC' && $extras['col'] == 'data_fim') ? 'DESC' : 'ASC' ) ), $extras['url']), 'class' => ( ($extras['col'] == 'data_fim' ) ? 'ui-state-highlight'.( ($extras['col'] == 'data_fim' && $extras['ordem'] == 'ASC') ? ' ui-icon-caract-1-n' : ' ui-icon-caract-1-s' ) : 'ui-state-disabled ui-icon-caract-1-s' ) ),
