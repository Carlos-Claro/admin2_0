...
class Imoveis extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'imoveis_model', 'empresas_model', 'empresas_auxiliar_model', 'subcategorias_model',
            'status_atualizada_model', 'logradouros_model', 'cidades_model', 'empresas_status_ocorrencia_model',
            'empresas_contato_model', 'setores_model', 'ocorrencias_model', 'interacao_model', 'pow_cargos_model',
            'sistema_model'));
    ...
    public function listar($coluna = 'id', $ordem = 'DESC', $off_set = 0)
    {
        ...
        $itens = $this->imoveis_model->get_itens($filtro->get_filtro(), $coluna, $ordem, $off_set);
        $total = $this->imoveis_model->get_total_itens($filtro->get_filtro());
    ...
    private function _inicia_listagem_auxiliar($itens, $extras = NULL, $exportar = FALSE, $ordenacao = TRUE)
    {
        if ($exportar) {
            ...
            $data['cabecalho'] = array(
                array('titulo' => 'Imovel', 'classe' => 'alert alert-success', 'itens' => array(
                    (object)array('chave' => 'foto1', 'classe' => 'col-md-4', 'acao' => 'set_foto_imovel', 'complemento' => 'id_empresa'),
                    (object)array('chave' => 'tipo', 'titulo' => 'Tipo', 'classe' => 'col-sm-8',),
                    (object)array('chave' => 'id', 'titulo' => 'Código', 'classe' => 'col-sm-4',),
                    (object)array('chave' => 'referencia', 'titulo' => 'Referência', 'classe' => 'col-sm-4',),
                    (object)array('chave' => 'data_atualizacao', 'titulo' => 'Atualização', 'classe' => 'col-sm-8',),
                )),
                array('classe' => 'alert alert-success', 'itens' => array(
                    (object)array('chave' => 'valores', 'classe' => 'col-sm-12', 'acao' => 'set_valores_imovel'),
                )),
            );

            $data['operacoes'] = array(
                (object)array('titulo' => 'Estatísticas', 'class' => 'col-lg-4 col-sm-4 col-md-4 col-xs-4 btn btn-warning pull-left', 'icone' => '<span class="glyphicon glyphicon-ok"></span>', 'link' => 'empresas/editar_auxiliar/aprovado/[id]', 'extra' => ''),
                (object)array('titulo' => 'Editar', 'class' => 'col-lg-4 col-sm-4 col-md-4 col-xs-4 btn btn-info pull-left', 'icone' => '<span class="glyphicon glyphicon-ok"></span>', 'link' => 'empresas/salvar_auxiliar/[id]', 'extra' => ''),
                (object)array('titulo' => 'Excluir', 'class' => 'col-lg-4 col-sm-4 col-md-4 col-xs-4 btn btn-danger pull-right remover-auxiliar', 'icone' => '<span class="glyphicon glyphicon-remove"></span>', 'extra' => ''),
            );
