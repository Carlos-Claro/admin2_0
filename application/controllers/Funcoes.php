...
{       
	...
	public function __construct()
	{
        ...
        public function get_itens_mysql()
        {
            $this->load->model(array('imoveis_model'));
            $filtro[] = array('tipo'=>'where', 'campo' => 'imoveis_tipos.link', 'valor' => 'apartamento');
            $resultado_mongo = $this->imoveis_model->get_itens_com_foto($filtro);
            var_dump($resultado_mongo);
